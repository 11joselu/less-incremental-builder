...
exports.logErrorMainFile = (err, mainFile) => {
  this.logErrorBuild(err);
  const message = chalk.grey(`Please resolve the issues and make a change inside ${mainFile}, to create correct a build file`);
  log(message);
}
